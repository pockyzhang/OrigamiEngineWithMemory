Pod::Spec.new do |s|
  s.name                  = "OrigamiEngineWithMemory"
  s.version               = "1.0.0"
  s.summary               = "Lightweight iOS/OSX audio engine with flac, cue, mp3, m4a, m3u support.Add memory support"
  s.homepage              = "https://github.com/pockyzhang/OrigamiEngineWithMemory.git"
  s.license               = 'MIT'
  s.author                = { "ap4y" => "lod@pisem.net" }
  s.source                = { :git => "https://github.com/pockyzhang/OrigamiEngineWithMemory.git", :tag => "1.0.0", :submodules => true }
